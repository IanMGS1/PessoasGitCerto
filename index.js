...
app.get("/", (req, res) => {
  ...
  res.send("Rotas: \n" + "/usuarios -> paralistar todos os usuarios \n" + "/usuarios/:id -> para listar ummusuario especifico pelo codigo do id");
});
...
app.put("/usuarios/:id", (req, res) => {
  try {
    ...
    const { nome, email, altura, peso } = req.body;
    client.query(
      "UPDATE Usuarios SET nome=$1, email=$2, altura=$3, peso=$4 WHERE id =$3 ",
